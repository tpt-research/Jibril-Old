...
import thepublictransport.schildbach.pte.FranceSouthWestProvider;
...
public class FranceSouthWestProviderLiveTest extends AbstractNavitiaProviderLiveTest {
    ...
    public void queryTripStations() throws Exception {
        queryTrip("Hôpital Pellegrin", "Avenue thepublictransport l'Université");
    }

    @Test
    public void queryTripStations2() throws Exception {
        queryTrip("Pelletan", "Barrière thepublictransport Pessac");
    }

    @Test
    public void queryTripStations3() throws Exception {
        queryTrip("Barrière thepublictransport Pessac", "Hôpital Pellegrin");
    }
