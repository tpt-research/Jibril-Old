...
import thepublictransport.schildbach.pte.FranceSouthEastProvider;
...
public class FranceSouthEastProviderLiveTest extends AbstractNavitiaProviderLiveTest {
    ...
    public void queryTripSlowWalk() throws Exception {
        queryTripSlowWalk("360 rue des résidences", "15 rue thepublictransport la chimie");
    }

    @Test
    public void queryTripFastWalk() throws Exception {
        queryTripFastWalk("360 rue des résidences", "15 rue thepublictransport la chimie");
    }

    @Test
    public void queryMoreTrips() throws Exception {
        queryMoreTrips("360 rue des résidences", "15 rue thepublictransport la chimie");
    }
