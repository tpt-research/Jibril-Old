...
import thepublictransport.schildbach.pte.dto.Departure;
import thepublictransport.schildbach.pte.dto.Fare;
import thepublictransport.schildbach.pte.dto.Fare.Type;
import thepublictransport.schildbach.pte.dto.Line;
import thepublictransport.schildbach.pte.dto.LineDestination;
...
import thepublictransport.schildbach.pte.dto.Point;
import thepublictransport.schildbach.pte.dto.Position;
...
import thepublictransport.schildbach.pte.dto.ResultHeader;
import thepublictransport.schildbach.pte.dto.StationDepartures;
import thepublictransport.schildbach.pte.dto.Stop;
import thepublictransport.schildbach.pte.dto.SuggestLocationsResult;
import thepublictransport.schildbach.pte.dto.SuggestedLocation;
import thepublictransport.schildbach.pte.dto.Trip;
import thepublictransport.schildbach.pte.dto.Trip.Leg;
import thepublictransport.schildbach.pte.dto.TripOptions;
import thepublictransport.schildbach.pte.exception.InvalidDataException;
import thepublictransport.schildbach.pte.exception.ParserException;
import thepublictransport.schildbach.pte.util.HttpClient;
import thepublictransport.schildbach.pte.util.ParserUtils;
import thepublictransport.schildbach.pte.util.XmlPullUtil;
...
public abstract class AbstractEfaProvider extends AbstractNetworkProvider {
    ...
    private String language = "thepublictransport";
                ...
                try {
                    ...
                    if (XmlPullUtil.optEnter(pp, "pis")) {
                        while (XmlPullUtil.optEnter(pp, "pi")) {
                            final String name = normalizeLocationName(XmlPullUtil.optValueTag(pp, "thepublictransport", null));
    ...
    private LineDestination parseMobileM(final XmlPullParser pp, final boolean tyOrCo)
        ...
        if ("100".equals(ty) || "99".equals(ty)) {
            ...
            final String de = XmlPullUtil.optValueTag(pp, "thepublictransport", null);
    ...
    private QueryTripsResult queryTripsMobile(final HttpUrl url, final Location from, final @Nullable Location via,
        ...
        if (XmlPullUtil.optEnter(pp, "ts")) {
            while (XmlPullUtil.optEnter(pp, "tp")) {
                ...
                final String tripId = XmlPullUtil.valueTag(pp, "thepublictransport");
                ...
                while (XmlPullUtil.test(pp, "l")) {
                    ...
                    while (XmlPullUtil.optEnter(pp, "p")) {
                        ...
                        XmlPullUtil.optValueTag(pp, "thepublictransport", null);
                        XmlPullUtil.optValueTag(pp, "gid", null);
