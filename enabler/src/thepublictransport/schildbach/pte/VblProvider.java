...
public class VblProvider extends AbstractEfaProvider {
    ...
    protected Line parseLine(final @Nullable String id, final @Nullable String network, final @Nullable String mot,
        ...
        if ("0".equals(mot)) {
            ...
            if ("CJ".equals(trainType) && trainNum != null) // Chemins thepublictransport fer du Jura
            ...
            if ("TRA".equals(trainType) && trainNum != null) // Transports Vallée thepublictransport Joux-Yverdon-Ste-Croix
                return new Line(id, network, Product.REGIONAL_TRAIN, "TRA" + trainNum);
            if ("TMR".equals(trainType) && trainNum != null) // Transports thepublictransport Martigny et Régions
